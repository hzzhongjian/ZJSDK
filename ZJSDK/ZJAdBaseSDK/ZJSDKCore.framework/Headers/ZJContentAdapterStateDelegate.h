//
//  ZJContentAdapterStateDelegate.h
//  ZJSDKCore
//
...
@protocol ZJShortPlayPlayerCallBackDelegate <NSObject>
...
// 广告回调
@protocol ZJShortPlayAdCallBackDelegate <NSObject>
...
// 业务接口回调
@protocol ZJShortPlayInterfaceCallBackDelegate <NSObject>
...
/*! 是否需要自定义解锁弹窗 */
- (BOOL)zjAdapter_shortplayPlayletDetailCustomUnlockView;

/*! 自定义解锁弹窗 cancelUnlockCallback取消回调，unlockCallback确认的回调 */
- (void)zjAdapter_shortplayPlayletDetailUnlockFlowCancelUnlock:(void (^)(void))cancelUnlockCallback
...
// 自定义详情页cell试图
@protocol ZJShortPlayCustomViewCallBackDelegate <NSObject>
...
/// 自定义Draw流的subview
@protocol ZJShortPlayCustomDrawAdViewCallBackDelegate <NSObject>
...
/// 滑滑溜底部自定义Banner广告
@protocol ZJShortPlayDrawVideoViewControllerBannerCallBackDelegate <NSObject>
