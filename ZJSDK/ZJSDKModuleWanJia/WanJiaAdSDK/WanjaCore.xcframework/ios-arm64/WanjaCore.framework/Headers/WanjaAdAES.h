...
@interface WanjaAdAES : NSObject

+ (NSString *)WanjaAdAESEncrypt:(NSString *)originalStr
                      mode:(MIUMode)mode
                       key:(NSString *)key
...
+ (NSString *)WanjaAdAESDecrypt:(NSString *)originalStr
                      mode:(MIUMode)mode
                       key:(NSString *)key
                   keySize:(MIUKeySizeAES)keySize
                        iv:(NSString * _Nullable )iv
...
+ (NSData *)WanjaAdAESEncryptData2:(NSData *)originalData
                      mode:(MIUMode)mode
                       key:(NSString *)key
                   keySize:(MIUKeySizeAES)keySize
                        iv:(NSString * _Nullable )iv
...
+ (NSString *)WanjaAdAESEncryptData:(NSData *)originalData
                      mode:(MIUMode)mode
                       key:(NSString *)key
                   keySize:(MIUKeySizeAES)keySize
                        iv:(NSString * _Nullable )iv
...
//+ (NSString *)WanjaAdAESDecryptData:(NSData *)originalData
//                      mode:(MIUMode)mode
//                       key:(NSString *)key
//                   keySize:(MIUKeySizeAES)keySize
//                        iv:(NSString * _Nullable )iv
