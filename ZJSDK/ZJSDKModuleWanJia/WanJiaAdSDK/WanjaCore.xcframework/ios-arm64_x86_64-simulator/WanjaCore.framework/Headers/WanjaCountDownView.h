...
/**
 首页倒计时，可点击关闭按钮
*/
@protocol WanjaCountDownCloseDelegate <NSObject>
...
@interface WanjaCountDownView : UIView

@property (nonatomic, weak) id<WanjaCountDownCloseDelegate> delegate;
