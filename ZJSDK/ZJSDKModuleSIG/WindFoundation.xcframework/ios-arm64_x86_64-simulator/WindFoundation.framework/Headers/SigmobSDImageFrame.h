...
/**
 This class is used for creating animated images via `animatedImageWithFrames` in `SigmobSDImageCoderHelper`.
 @note If you need to specify animated images loop count, use `sigmobsd_imageLoopCount` property in `UIImage+Metadata.h`.
 */
@interface SigmobSDImageFrame : NSObject
