 ...
 */
FOUNDATION_EXPORT NSString * _Nullable SigmobSDTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);
...
/**
 ...
 @note If you have both transformer and thumbnail applied for image, call `SigmobSDThumbnailedKeyForKey` firstly and then with `SDTransformedKeyForKey`.`
 */
FOUNDATION_EXPORT NSString * _Nullable SigmobSDThumbnailedKeyForKey(NSString * _Nullable key, CGSize thumbnailPixelSize, BOOL preserveAspectRatio);
 ...
 */
@protocol SigmobSDImageTransformer <NSObject>

@optional

/**
 Defaults to YES if you don't implements this method.
 We keep some metadata like Image Format (`sd_imageFormat`)/ Animated Loop Count (`sigmobsd_imageLoopCount`) via associated object on UIImage instance.
 ...
 */
@interface SigmobSDImagePipelineTransformer : NSObject<SigmobSDImageTransformer>
 ...
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<SigmobSDImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)new  NS_UNAVAILABLE;

+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<SigmobSDImageTransformer>> *)transformers;
...
@interface SigmobSDImageBaseTransformer : NSObject<SigmobSDImageTransformer>
 ...
 */
@interface SigmobSDImageRoundCornerTransformer: SigmobSDImageBaseTransformer
 ...
 */
@property (nonatomic, assign, readonly) SigmobSDRectCorner corners;
...
+ (nonnull instancetype)transformerWithRadius:(CGFloat)cornerRadius corners:(SigmobSDRectCorner)corners borderWidth:(CGFloat)borderWidth borderColor:(nullable UIColor *)borderColor;
 ...
 */
@interface SigmobSDImageResizingTransformer : SigmobSDImageBaseTransformer
 ...
 */
@property (nonatomic, assign, readonly) SigmobSDImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)new  NS_UNAVAILABLE;

+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(SigmobSDImageScaleMode)scaleMode;
 ...
 */
@interface SigmobSDImageCroppingTransformer : SigmobSDImageBaseTransformer
 ...
 */
@interface SigmobSDImageFlippingTransformer : SigmobSDImageBaseTransformer
 ...
 */
@interface SigmobSDImageRotationTransformer : SigmobSDImageBaseTransformer
 ...
 */
@interface SigmobSDImageTintTransformer : SigmobSDImageBaseTransformer
 ...
 */
@interface SigmobSDImageBlurTransformer : SigmobSDImageBaseTransformer
 ...
 */
@interface SigmobSDImageFilterTransformer: SigmobSDImageBaseTransformer
