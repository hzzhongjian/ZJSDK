...
typedef NS_ENUM(NSUInteger, SigmobSDImageScaleMode) {
    /// The option to scale the content to fit the size of itself by changing the aspect ratio of the content if necessary.
    SigmobSDImageScaleModeFill = 0,
    /// The option to scale the content to fit the size of the view by maintaining the aspect ratio. Any remaining area of the view’s bounds is transparent.
    SigmobSDImageScaleModeAspectFit = 1,
    /// The option to scale the content to fill the size of the view. Some portion of the content may be clipped to fill the view’s bounds.
    SigmobSDImageScaleModeAspectFill = 2
};

typedef UIRectCorner SigmobSDRectCorner;
 ...
 */
- (nullable UIImage *)sigmobsd_resizedImageWithSize:(CGSize)size scaleMode:(SigmobSDImageScaleMode)scaleMode;
 ...
 */
- (nullable UIImage *)sigmobsd_croppedImageWithRect:(CGRect)rect;
 ...
 */
- (nullable UIImage *)sigmobsd_roundedCornerImageWithRadius:(CGFloat)cornerRadius
                                              corners:(SigmobSDRectCorner)corners
 ...
 */
- (nullable UIImage *)sigmobsd_rotatedImageWithAngle:(CGFloat)angle fitSize:(BOOL)fitSize;
 ...
 */
- (nullable UIImage *)sigmobsd_flippedImageWithHorizontal:(BOOL)horizontal vertical:(BOOL)vertical;
 ...
 */
- (nullable UIImage *)sigmobsd_tintedImageWithColor:(nonnull UIColor *)tintColor;
...
/**
 ...
 @return The new image with the tint color.
 */
- (nullable UIImage *)sigmobsd_tintedImageWithColor:(nonnull UIColor *)tintColor blendMode:(CGBlendMode)blendMode;
 ...
 */
- (nullable UIColor *)sigmobsd_colorAtPoint:(CGPoint)point;
 ...
 */
- (nullable NSArray<UIColor *> *)sigmobsd_colorsWithRect:(CGRect)rect;
 ...
 */
- (nullable UIImage *)sigmobsd_blurredImageWithRadius:(CGFloat)blurRadius;
...
/**
 ...
 enough memory).
 */
- (nullable UIImage *)sigmobsd_filteredImageWithFilter:(nonnull CIFilter *)filter;
