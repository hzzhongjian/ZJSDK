...
#import "SigmobSDImageFrame.h"

/// Image Decoding/Encoding Options
typedef NSString * SigmobSDImageCoderOption NS_STRING_ENUM;
typedef NSDictionary<SigmobSDImageCoderOption, id> SigmobSDImageCoderOptions;
typedef NSMutableDictionary<SigmobSDImageCoderOption, id> SigmobSDImageCoderMutableOptions;
...
/**
 ...
 @note works for `SigmobSDImageCoder`.
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderDecodeFirstFrameOnly;
...
/**
 ...
 @note works for `SigmobSDImageCoder`, `SigmobSDProgressiveImageCoder`, `SigmobSDAnimatedImageCoder`.
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderDecodeScaleFactor;
...
/**
 ...
 @note works for `SigmobSDImageCoder`, `SigmobSDProgressiveImageCoder`, `SigmobSDAnimatedImageCoder`.
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderDecodePreserveAspectRatio;
...
/**
 ...
 @note works for `SigmobSDImageCoder`, `SigmobSDProgressiveImageCoder`, `SigmobSDAnimatedImageCoder`.
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderDecodeThumbnailPixelSize;
 ...
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderDecodeFileExtensionHint;
 ...
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderDecodeTypeIdentifierHint;
...
/**
 ...
 @note works for `SigmobSDImageCoder`, `SigmobSDProgressiveImageCoder`, `SigmobSDAnimatedImageCoder`.
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderDecodeUseLazyDecoding;
...
/**
 ...
 @note You can use the logic from `+[SigmobSDImageCoder scaledSizeWithImageSize:limitBytes:bytesPerPixel:frameCount:]`
 @note This option has higher priority than `.decodeThumbnailPixelSize`
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderDecodeScaleDownLimitBytes;

/**
 A Boolean (`SigmobSDImageHDRType.rawValue`) value (stored inside NSNumber) to provide converting to HDR during decoding. Currently if number is 0 (`SigmobSDImageHDRTypeSDR`), use SDR, else use HDR. But we may extend this option to represent `SigmobSDImageHDRType` all cases in the future (means, think this options as uint number, but not actual boolean)
 ...
 @note works for `SigmobSDImageCoder`
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderDecodeToHDR;

#pragma mark - Image Encoding Options
/**
 A NSUInteger (`SigmobSDImageHDRType.rawValue`) value (stored inside NSNumber) to provide converting to HDR during encoding. Read the below carefully to choose the value.
 @note 0(`SigmobSDImageHDRTypeSDR`) means SDR; 1(`SDImageHDRTypeISOHDR`) means ISO HDR (at least using 10 bits per components or above, supported by AVIF/HEIF/JPEG-XL); 2(`SDImageHDRTypeISOGainMap`) means ISO Gain Map HDR (may use 8 bits per components, supported by AVIF/HEIF/JPEG-XL, as well as traditional JPEG)
 ...
 @note works for `SigmobSDImageCoder`
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderEncodeToHDR;
...
/**
 ...
 @note works for `SigmobSDImageCoder`.
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderEncodeFirstFrameOnly;
/**
 ...
 @note works for `SigmobSDImageCoder`
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderEncodeCompressionQuality;
...
/**
 ...
 @note works for `SigmobSDImageCoder`
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderEncodeBackgroundColor;
...
/**
 ...
 @note works for `SigmobSDImageCoder`
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderEncodeMaxPixelSize;
...
/**
 ...
 @note works for `SigmobSDImageCoder`
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderEncodeMaxFileSize;
...
/**
 ...
 @note works for `SigmobSDImageCoder`
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderEncodeEmbedThumbnail;
...
/**
 ...
 @warning Deprecated. This does nothing from 5.14.0. Use `SDWebImageContextImageDecodeOptions` to pass additional information in top-level API, and use `SigmobSDImageCoderOptions` to retrieve options from coder.
 */
FOUNDATION_EXPORT SigmobSDImageCoderOption _Nonnull const SigmobSDImageCoderWebImageContext API_DEPRECATED("No longer supported. Use SDWebImageContextDecodeOptions in loader API to provide options. Use SDImageCoderOptions in coder API to retrieve options.", macos(10.10, 10.10), ios(8.0, 8.0), tvos(9.0, 9.0), watchos(2.0, 2.0));
 ...
 */
@protocol SigmobSDImageCoder <NSObject>
...
/**
 ...
 @note This protocol may supports decode animated image frames. You can use `+[SigmobSDImageCoderHelper animatedImageWithFrames:]` to produce an animated image with frames.
...
- (nullable UIImage *)decodedImageWithData:(nullable NSData *)data
                                   options:(nullable SigmobSDImageCoderOptions *)options;

#pragma mark - Encoding

/**
 Returns YES if this coder can encode some image. Otherwise, it should be passed to another coder.
 For custom coder which introduce new image format, you'd better define a new `SigmobSDImageFormat` using like this. If you're creating public coder plugin for new image format, also update `https://github.com/rs/SDWebImage/wiki/Coder-Plugin-List` to avoid same value been defined twice.
 * @code
 static const SDImageFormat SigmobSDImageFormatHEIF = 10;
 * @endcode
 
 @param format The image format
 @return YES if this coder can encode the image, NO otherwise
 */
- (BOOL)canEncodeToFormat:(SigmobSDImageFormat)format NS_SWIFT_NAME(canEncode(to:));

/**
 Encode the image to image data.
 @note This protocol may supports encode animated image frames. You can use `+[SigmobSDImageCoderHelper framesFromAnimatedImage:]` to assemble an animated image with frames. But this consume time is not always reversible. In 5.15.0, we introduce `encodedDataWithFrames` API for better animated image encoding. Use that instead.
 @note Which means, this just forward to `encodedDataWithFrames([SDImageFrame(image: image, duration: 0], image.sigmobsd_imageLoopCount))`
...
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image
                                   format:(SigmobSDImageFormat)format
                                  options:(nullable SigmobSDImageCoderOptions *)options;
...
/**
 ...
 @param loopCount The final animated image loop count. 0 means infinity loop. This config ignore each frame's `sigmobsd_imageLoopCount`
 @param format The image format to encode, you should note `SDImageFormatUndefined` format is also  possible
 @param options A dictionary containing any encoding options. Pass @{SDImageCoderEncodeCompressionQuality: @(1)} to specify compression quality.
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithFrames:(nonnull NSArray<SigmobSDImageFrame *>*)frames
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol SigmobSDProgressiveImageCoder <SigmobSDImageCoder>
 ...
 */
- (nonnull instancetype)initIncrementalWithOptions:(nullable SigmobSDImageCoderOptions *)options;
...
/**
 ...
 @note Due to the performance issue for progressive decoding and the integration for image view. This method may only return the first frame image even if the image data is animated image. If you want progressive animated image decoding, conform to `SigmobSDAnimatedImageCoder` protocol as well and use `animatedImageFrameAtIndex:` instead.
 ...
 */
- (nullable UIImage *)incrementalDecodedImageWithOptions:(nullable SigmobSDImageCoderOptions *)options;

@end

#pragma mark - Animated Image Provider
/**
 This is the animated image protocol to provide the basic function for animated image rendering. It's adopted by `SigmobSDAnimatedImage` and `SigmobSDAnimatedImageCoder`
 */
@protocol SigmobSDAnimatedImageProvider <NSObject>
...
/**
 This is the animated image coder protocol for custom animated image class like  `SigmobSDAnimatedImage`. Through it inherit from `SigmobSDImageCoder`. We currentlly only use the method `canDecodeFromData:` to detect the proper coder for specify animated image format.
 */
@protocol SigmobSDAnimatedImageCoder <SigmobSDImageCoder, SigmobSDAnimatedImageProvider>
 ...
 */
- (nullable instancetype)initWithAnimatedImageData:(nullable NSData *)data options:(nullable SigmobSDImageCoderOptions *)options;
