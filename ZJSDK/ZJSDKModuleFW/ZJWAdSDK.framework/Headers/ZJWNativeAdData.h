...
@interface ZJWMediaInfo: NSObject
/// 素材宽
...
@interface ZJWNativeAdData : NSObject
...
/// 素材地址
@property (nonatomic, strong, readonly) NSArray <ZJWMediaInfo *> *imageUrls;
/// 视频类素材描述
@property (nonatomic, strong, readonly) ZJWMediaInfo *videoAdInfo;
