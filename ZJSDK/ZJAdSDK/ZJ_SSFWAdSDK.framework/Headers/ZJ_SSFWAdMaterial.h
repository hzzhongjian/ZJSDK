...
@class ZJ_SSFWMediaInfo;


@interface ZJ_SSFWAdMaterial : NSObject

/// 素材 id
@property(nonatomic,copy)NSString *materialId;
/// 广告主图
@property(nonatomic,strong)ZJ_SSFWMediaInfo *image;
/// 广告标题  可能为空
...
/// 广告图片集合 用于多图信息流
@property(nonatomic,copy)NSArray<ZJ_SSFWMediaInfo *> *images;
@property(nonatomic,strong)ZJ_SSFWMediaInfo *videoAdInfo;
/// 点击按钮文案
