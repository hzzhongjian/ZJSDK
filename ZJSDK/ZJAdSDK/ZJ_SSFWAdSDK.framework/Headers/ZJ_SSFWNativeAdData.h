...
@class ZJ_SSFWAdMaterial;

NS_ASSUME_NONNULL_BEGIN

@interface ZJ_SSFWMediaInfo: NSObject
/// 素材宽
...
@interface ZJ_SSFWNativeAdData : NSObject
...
/// 素材地址
@property (nonatomic, strong, readonly) NSArray <ZJ_SSFWMediaInfo *> *imageUrls;
/// 视频类素材描述
@property (nonatomic, strong, readonly) ZJ_SSFWMediaInfo *videoAdInfo;
